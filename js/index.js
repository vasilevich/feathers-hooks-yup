 ...
 */
var yupValidationHook = function (yupSchemaObject, yupOptions, translations) {
    if (yupOptions === void 0) { yupOptions = {}; }
    if (translations === void 0) { translations = function (formattedErrors) { return formattedErrors; }; }
    return function (context) { return __awaiter(void 0, void 0, void 0, function () {
        var data, errors_2, formattedErrors, _i, _a, inner;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, yupSchemaObject.validate(data, yupOptions)];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 4];
                case 3:
...
exports.default = yupValidationHook;
